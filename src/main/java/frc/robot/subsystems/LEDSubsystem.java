...
public class LEDSubsystem extends SubsystemBase {
    ...
    private final TwinkleOffAnimation m_manipulatorNotReady =   new TwinkleOffAnimation(    255 ,0   ,0   ,0   ,1   ,   Constants.LEDConstants.kRGBCount, TwinkleOffAnimation.TwinkleOffPercent.Percent64);
    private final StrobeAnimation m_manipulatorReady =          new StrobeAnimation(        255 ,0   ,0   ,0   ,1   ,   Constants.LEDConstants.kRGBCount);
    private final LarsonAnimation m_climbLEFT=                  new LarsonAnimation(        165 ,255 ,0   ,0   ,0.25,   Constants.LEDConstants.kRGBSection1Count, LarsonAnimation.BounceMode.Back, 3, Constants.LEDConstants.kRGBCANdleCount);
    private final LarsonAnimation m_climbRIGHT=                 new LarsonAnimation(        165 ,255 ,0   ,0   ,0.25,   Constants.LEDConstants.kRGBSection3Count, LarsonAnimation.BounceMode.Back, 3, Constants.LEDConstants.kRGBCANdleCount + Constants.LEDConstants.kRGBSection1Count + Constants.LEDConstants.kRGBSection2Count);
        ...
        if ((m_currentState != m_pastState) || colorUpdate) {
            switch (m_currentState) {
                ...
                case MANIPULATOR_READY:
                    ...
                    break;
                case CLIMB:
                    m_candle.animate(m_climbRIGHT, 1);
