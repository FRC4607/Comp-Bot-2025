  ...
  public RetractDown(WindmillSubsystem windmill, ElevatorSubsystem elevator) {
    super(
      new ConditionalCommand(
        new ConditionalCommand(
          new SetWindmillSetpoint(60, 15, elevator, windmill), 
          new SetWindmillSetpoint(120, 15, elevator, windmill), 
          () -> windmill.getPosition() >= 90
          ),
        new InstantCommand(),  
      () -> windmill.getPosition() < 170 && windmill.getPosition() > 10
      ),
      new SetElevatorSetpoint(25, 2, elevator, windmill),
      new SetWindmillSetpoint(270, 5, elevator, windmill)
    );
  }
}
